...
public class Main {
    public static void main(String[] args) {
        ...
        // CrudOperations.addStudent("Umut Emre", "Onder", "umutemreonder@gmail.com", 2, 3); // Will add the student to the course 2 and 3, also creates rows on class_student table
